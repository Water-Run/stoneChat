...
No proxy, hosts-file edit, or manual stunnel startup is required. On the
first HTTPS request stoneChat starts stunnel in the background and generates
an SNI- and hostname-verifying configuration for the selected API host.
